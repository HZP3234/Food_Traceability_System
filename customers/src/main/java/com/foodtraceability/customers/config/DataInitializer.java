    ...
    public void run(String... args) throws Exception {
        try (Connection conn = dataSource.getConnection();
            ...
            stmt.execute("CREATE TABLE IF NOT EXISTS t_complaint_record (" +
                ...
                "complaint_content CLOB NOT NULL," +
            ...
            stmt.execute("CREATE TABLE IF NOT EXISTS consumer (" +
                "id BIGINT AUTO_INCREMENT PRIMARY KEY," +
            ...
            stmt.execute("CREATE UNIQUE INDEX IF NOT EXISTS idx_consumer_phone ON consumer(phone)");
        }
    }
}
